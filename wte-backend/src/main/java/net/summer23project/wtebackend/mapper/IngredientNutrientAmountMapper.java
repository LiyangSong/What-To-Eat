...
public class IngredientNutrientAmountMapper {
    ...
    //
    //public IngredientNutrientAmountReturnDto mapToIngredientNutrientAmountDto(
    ...
    //        IngredientNutrientAmountReturnDto ingredientNutrientAmountReturnDto) {
    //
    //    String ingredientName = ingredientNutrientAmountReturnDto.getIngredientName();
    ...
    //
    //    String nutrientName = ingredientNutrientAmountReturnDto.getNutrientName();
    ...
    //    ingredientNutrientAmount.setNutrientAmount(ingredientNutrientAmountReturnDto.getNutrientAmount());
    //
